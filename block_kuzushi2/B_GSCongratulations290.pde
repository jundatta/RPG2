...
class GameSceneCongratulations290 extends GameSceneCongratulationsBase {
  // Create Globe
  Globe globe;
  ...
  @Override void setup() {
    ...
    // Load Image
    back = loadImage("data/290/background.jpg");
  ...
  class Globe {
    ...
    Globe() {
      // Load Scene
      scene = loadImage("data/290/scene_2.png");
      sceneHit = loadImage("data/290/scene_2_hit.png");
